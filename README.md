# [Cockatrice](https://cockatrice.github.io/) flatpak package
...
Also, make sure to change the `version` and `date` value for the `release` key in [appdata.xml](https://github.com/flathub/io.github.Cockatrice.cockatrice/blob/master/io.github.Cockatrice.appdata.xml#L19) as well.

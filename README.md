# Flatpak package for [<kbd>Cockatrice</kbd>](https://cockatrice.github.io/)
...
Also, make sure to adjust the `version` and `date` values for the **release** key in [appdata.xml](https://github.com/flathub/io.github.Cockatrice.cockatrice/blob/master/io.github.Cockatrice.appdata.xml#L33) in the process as well.
